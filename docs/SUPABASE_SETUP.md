...
| `SUPABASE_ANON_KEY` | servidor | Chave pública do ambiente |
...
| `SUPABASE_DB_URL` | segredo servidor | Transaction Pooler, porta 6543 |
...
| `APP_ALLOWED_ORIGINS` | servidor | CSV de origins exatas |
